export default () => {
    ...
    const footerNavs = [
        {
            href: 'https://satyamregmi.com.np',
            name: 'Main'
        },
        {
            href: 'https://blog.satyamregmi.com.np',
            name: 'Blog'
        },
        {
        ...
        {
            href: 'https://satyamregmi.com.np/projects/',
            name: 'Projects'
        },
        {
            href: 'https://games.satyamregmi.com.np',
            name: ' Apps and Games'
        },

        {
            href: 'https://satyamregmi.com.np/contact',
            name: 'Contact'
        }
    ]

    return (
        <footer className="text-white-500 nx-border-t px-4 py-5 max-w-screen-xxl w-full mx-auto md:px-8">
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; {new Date().getFullYear()} Satyam Regmi All rights reserved.
                </div>
